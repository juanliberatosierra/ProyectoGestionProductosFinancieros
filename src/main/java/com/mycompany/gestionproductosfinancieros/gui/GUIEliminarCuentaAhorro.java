 ...
 * @author Juan Camilo
 */
public class GUIEliminarCuentaAhorro extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIEliminarCuentaAhorro.class.getName());
    private final ServicioProductoFinanciero servicioProductoFinanciero
            = ServicioProductoFinanciero.getInstancia();

    /**
     * Creates new form GUIEliminarCuentaAhorro
     */
    public GUIEliminarCuentaAhorro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Eliminar Cuenta de Ahorro");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIEliminarCuentaAhorro().setVisible(true));
    }
