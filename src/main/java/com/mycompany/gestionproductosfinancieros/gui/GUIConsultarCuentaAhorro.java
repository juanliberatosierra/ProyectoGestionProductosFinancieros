 ...
 * @author Juan Camilo
 */
public class GUIConsultarCuentaAhorro extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(GUIConsultarCuentaAhorro.class.getName());
    private final ServicioProductoFinanciero servicioProductoFinanciero
            = ServicioProductoFinanciero.getInstancia();

    /**
     * Creates new form GUIConsultarCuentaAhorro
     */
    public GUIConsultarCuentaAhorro() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Consultar Cuenta de Ahorro");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new GUIConsultarCuentaAhorro().setVisible(true));
    }
